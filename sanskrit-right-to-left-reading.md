...
[`assets/klammerdiagramm-target-plate.png`](https://github.com/gasyoun/SamasaChakram/blob/main/klammerdiagramm/klammerdiagramm-target-plate.png) —
recovered 14-07-2026 from the H814 session transcript, MG's 12-07 upload):
[`assets/klammerdiagramm-uddama-example.svg`](https://github.com/gasyoun/SamasaChakram/blob/main/klammerdiagramm/klammerdiagramm-uddama-example.svg),
generated by `assets/build_klammerdiagramm.py` —
...
[`assets/OFL-Charis.txt`](https://github.com/gasyoun/SamasaChakram/blob/main/klammerdiagramm/OFL-Charis.txt), provenance
[`assets/make_charis_subset.py`](https://github.com/gasyoun/SamasaChakram/blob/main/klammerdiagramm/make_charis_subset.py)) — 1:1 rendering with no
